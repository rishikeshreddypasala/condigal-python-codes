...
# Emolis for the start of the program
...
print(f"Type a sentence and I will analyze your sentences with TextBloband show you the sentiment.")
...
while True:
    ...
    if user_input.lower() == "exit":
        ...
        print(f"{Fore.CYAN} All coversation history cleared!{Style.RESET_ALL}")
        continue
